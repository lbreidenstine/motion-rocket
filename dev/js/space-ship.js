...
spaceShipTL.from("#landing-pad",{alpha:0, duration:1}, "fadein")
            ...
            .to("#small-artifact",{x:10, duration:1}, "guns")
            .to("#medium-artifact",{x:20, duration:2}, "guns")
            .to("#big-artifact",{x:15, duration:1}, "guns")
            .from("#middle-right-gun",{rotation: 90, duration:1}, "guns")
            .from("#middle-left-gun",{rotation: 90, duration:1}, "guns")
            .to("#small-artifact",{x:50, duration:5}, "launching")
            .to("#medium-artifact",{x:60, duration:7}, "launching")
            .to("#big-artifact",{x:30, duration:4}, "launching")
